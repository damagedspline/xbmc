...
#if 0
LRESULT CALLBACK CWinEventsWin10::WndProc(HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
  XBMC_Event newEvent;
...
void CWinEventsWin10::OnGestureNotify(HWND hWnd, LPARAM lParam)
{
...
void CWinEventsWin10::OnGesture(HWND hWnd, LPARAM lParam)
{
