...
public:
  ...
  bool Convert(BYTE **poutbuf, int *poutbuf_size, const BYTE *buf, int buf_size);
...
{
public:
  CMVCPicture(MVCBuffer *pBaseView, MVCBuffer* pExtraBuffer) : baseView(pBaseView), extraView(pExtraBuffer)
  {
  }
  ~CMVCPicture() { release(this); }
  void(*release)(CMVCPicture*);
...
public:
  ...
  virtual void Reopen() {}; // not supported
  virtual bool GetPicture(DVDVideoPicture* pDvdVideoPicture);
  virtual void SetDropState(bool bDrop) {};
  virtual const char* GetName() { return "msdk-mvc"; };
  virtual bool GetCodecStats(double &pts, int &droppedPics) { return true; };
...
private:
  ...
  void DeliverOutput(MVCBuffer * pBaseView, MVCBuffer * pExtraView);

  static void ReleasePicture(CMVCPicture *pMvcPictures);
